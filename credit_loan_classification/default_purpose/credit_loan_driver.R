...
summaryInfo = smryMCMC_Kappa_Omega( mcmcCoda , compVal=0.5 , #rope=c(0.45,0.55) ,
                        compValDiff=0.0 ,  diffIdVec=c(1,2,8,9), #ropeDiff = c(-0.05,0.05) ,
                        saveName=fileNameRoot )
# Display posterior information:

plotMCMC_Kappa_Omega( mcmcCoda , data=df , compVal=0.5 , sName="Purpose" , yName="Credit_default", #rope=c(0.45,0.55) ,
          compValDiff=0.0 ,  diffIdVec=c(1,2,8,9), #ropeDiff = c(-0.05,0.05) ,
          saveName=fileNameRoot , saveType=graphFileType )
#------------------------------------------------------------------------------- 
